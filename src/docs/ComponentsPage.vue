      ...
      <column md="8" class="mx-auto">
        <jumbotron class="mt-5">
          ...
          <ul class="list-unstyled example-components-list">
            ...
            <!-- PRO -->
            <h6>PRO</h6>
            <a href="#/components/pro/button"><li>Button <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/card"><li>Cards <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/dropdown"><li>Dropdown <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/inputs"><li>Input <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/progress-bars-pro"><li>Progress Bar <fa icon="angle-right"/></li></a>
            <a href="#/components/pro/tabs"><li>Tabs <fa icon="angle-right"/></li></a>
          </ul>
        </jumbotron>
      </column>
    </row>
