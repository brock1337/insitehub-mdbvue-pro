<template>
      <form class="range-field">
        ...
        <span  v-if="thumbActive" :class="['thumb', {'active': thumbActive}]" :style="{left: leftPosition+'px', height: thumbHeight, width: thumbWidth, top: thumbTop, marginLeft: thumbMarginLeft}">
